...
این دستورها typecheck سخت‌گیرانه، bundle و ۲۷ تست runtime/security/extraction/Cloudflare-AI/مدیریت مقصد/UI را اجرا می‌کنند؛ audit جداگانه نیز bindingهای declarative، migrationها و 178 mapping سازگاری را کنترل می‌کند.
