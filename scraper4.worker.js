...
function password() {
  ...
  if (!validSecret(secret2)) throw new Error(`\u0628\u0631\u0627\u06CC \u0630\u062E\u06CC\u0631\u0647 \u0627\u0645\u0646 \u0627\u0637\u0644\u0627\u0639\u0627\u062A \u0627\u062A\u0635\u0627\u0644\u060C VAULT_SECRET \u0648 ADMIN_TOKEN \u0631\u0627 \u0628\u0627 \u062D\u062F\u0627\u0642\u0644 ${MIN_SECRET_LENGTH} \u06A9\u0627\u0631\u0627\u06A9\u062A\u0631 \u062F\u0631 Cloudflare Dashboard \u2190 Settings \u2190 Variables and Secrets \u0628\u0647\u200C\u0635\u0648\u0631\u062A Secret \u062A\u0639\u0631\u06CC\u0641 \u06A9\u0646\u06CC\u062F.`);
  return secret2;
}
...
app.use("/api/*", async (c, next) => {
  ...
  if (!validSecret(c.env.ADMIN_TOKEN) && c.env.ALLOW_INSECURE !== "true") return c.json({ ok: false, error: `ADMIN_TOKEN is not configured or is shorter than ${MIN_SECRET_LENGTH} characters. Add it as an encrypted Secret in Cloudflare Dashboard \u2192 Worker \u2192 Settings \u2192 Variables and Secrets, then deploy the change.` }, 503);
